...
Experiência interativa em três atos para o tema **“Protagonista ou coadjuvante?”**. A demonstração atual contém dezoito capítulos aprovados.
...
Inicie um servidor local na pasta do projeto e use `/?capitulo=NUMERO`. Capítulos disponíveis: 27, 34, 43, 56, 68, 82, 91, 104, 121, 132, 147, 176, 188, 201, 219, 245, 263 e 276. Use `/?capitulo=999` para validar o tratamento de capítulo inexistente.
...
Abra `cartoes-teste.html` e imprima em A4, escala de 100%, com gráficos de fundo ativados. A folha contém os dezoito capítulos aprovados em cartões de 85 × 55 mm. Não use “ajustar à página”.
